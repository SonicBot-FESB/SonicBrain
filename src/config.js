...
exports.CHARACTER_RECOGNITION_CLIENT_HOST =
  process.env["CHARACTER_RECOGNITION_CLIENT_HOST"];
exports.CHARACTER_RECOGNITION_CLIENT_PORT =
  process.env["CHARACTER_RECOGNITION_CLIENT_PORT"];
